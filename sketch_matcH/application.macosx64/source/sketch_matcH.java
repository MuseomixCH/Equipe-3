...
public class sketch_matcH extends PApplet {
...
int[] XX = new int[0];
int[] YY = new int[0];
int tint = PApplet.parseInt(random(0,100));
...
public void draw(){
  ...
  if(mode.equals("draw")){
    ...
    if(nFrameInMode == 1){
      ...
      tint = PApplet.parseInt(random(0,100));
    ...
    if(hands.size() >0){
      ...
      x = PApplet.parseInt(hand_position.x);
      y = PApplet.parseInt(hand_position.y);
      z = PApplet.parseInt(hand_position.z);
    }
...
public void showAllIndiv(int nFrameInMode, int userNumber){
...
public void createCollectiveImage(){
...
public void showCollectiveImages(int nFrameInMode){
  // display the next image in the list
...
public void mouseReleased(){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#000000", "--stop-color=#cccccc", "sketch_matcH" };
    if (passedArgs != null) {
